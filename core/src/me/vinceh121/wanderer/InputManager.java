...
public class InputManager extends ApplicationAdapter {
	...
	public void setDefaultBinds() {
		...
		this.bindings.put(Input.TURN_RIGHT, new Binding(Keys.RIGHT, DeviceType.KEYBOARD));
		this.bindings.put(Input.TURN_RIGHT, new Binding(Keys.D, DeviceType.KEYBOARD));
		this.bindings.put(Input.TURN_LEFT, new Binding(Keys.LEFT, DeviceType.KEYBOARD));
		this.bindings.put(Input.TURN_LEFT, new Binding(Keys.A, DeviceType.KEYBOARD));
		...
		this.bindings.put(Input.FLY_DOWN, new Binding(Keys.UP, DeviceType.KEYBOARD));
		this.bindings.put(Input.FLY_DOWN, new Binding(Keys.W, DeviceType.KEYBOARD));
		this.bindings.put(Input.FLY_UP, new Binding(Keys.DOWN, DeviceType.KEYBOARD));
		this.bindings.put(Input.FLY_UP, new Binding(Keys.S, DeviceType.KEYBOARD));
		...
		this.bindings.put(Input.DEBUG_AUDIO, new Binding(Keys.F7, DeviceType.KEYBOARD));
