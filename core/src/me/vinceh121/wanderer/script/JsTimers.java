...
public class JsTimers {
	...
	private Object setTimeout(final Context ctx, final Scriptable lscope, final Scriptable thisObj,
			final Object[] args) {
		...
		if (args.length == 2) {
			...
			timeout =
					new Timeout(ctx, lscope, thisObj, (Callable) args[0], ((Number) args[1]).floatValue(), timeoutArgs);
		} else {
	...
	private Object clearTimeout(final Context lcx, final Scriptable lscope, final Scriptable thisObj,
			final Object[] args) {
		if (args.length != 1) {
	...
	private Object setInterval(final Context ctx, final Scriptable lscope, final Scriptable thisObj,
			final Object[] args) {
		/// XXX Note: unlike spec-compliant Javascript, the this value is properly kept.
	...
	private Object clearInterval(final Context lcx, final Scriptable lscope, final Scriptable thisObj,
			final Object[] args) {
		if (args.length != 1) {
	...
	private static class Interval {
		...
		public Interval(final Context ctx, final Scriptable scope, final Scriptable thys, final Callable function,
				final float delay) {
			this(ctx, scope, thys, function, delay, new Object[0]);
		}

		public Interval(final Context ctx, final Scriptable scope, final Scriptable thys, final Callable function,
				final float delay, final Object[] args) {
			this.ctx = ctx;
			this.scope = scope;
			this.thys = thys;
	...
	private static class Timeout {
		...
		public Timeout(final Context ctx, final Scriptable scope, final Scriptable thys, final Callable function,
				final float timeRemaining) {
			this(ctx, scope, thys, function, timeRemaining, new Object[0]);
		}

		public Timeout(final Context ctx, final Scriptable scope, final Scriptable thys, final Callable function,
				final float timeRemaining, final Object[] args) {
			this.ctx = ctx;
			this.scope = scope;
			this.thys = thys;
			this.function = function;
