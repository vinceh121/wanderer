// Based on libgdx's default.fragment.glsl under the Apache 2.0 License,
// please read <https://github.com/libgdx/libgdx/blob/master/LICENSE>
// Modifications are under the GNU GPL 3.0 as the rest of Wanderer.
#ifdef GL_ES
#define LOWP lowp
#define MED mediump
#define HIGH highp
